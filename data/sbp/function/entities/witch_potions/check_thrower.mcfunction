...
execute as @e[type=minecraft:witch] if score @s uuid = #witch_potion_conversion_owner_uuid constant as @e[type=minecraft:splash_potion,limit=1,sort=nearest] run function sbp:entities/witch_potions/try_infestation
