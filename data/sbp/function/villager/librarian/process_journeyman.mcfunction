...
execute if score #random constant matches 001..050 run data modify entity @s Offers.Recipes[4] set value {maxUses:12,sell:{count:1,id:"minecraft:emerald"},buy:{count:5,id:"minecraft:ink_sac"},xp:20}
execute if score #random constant matches 051..100 run data modify entity @s Offers.Recipes[4] set value {maxUses:12,sell:{count:4,id:"minecraft:glass"},buy:{count:1,id:"minecraft:emerald"},xp:10}
