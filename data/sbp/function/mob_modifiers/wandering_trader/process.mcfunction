...
function sbp:mob_modifiers/wandering_trader/rotate/purchase
...
function math:random with storage minecraft:math random
function sbp:mob_modifiers/wandering_trader/rotate/special
...
function math:random with storage minecraft:math random
function sbp:mob_modifiers/wandering_trader/rotate/ordinary
